...
<body>
	...
	<?php } 
		if(( $a->show == 'insert' || $a->show == 'update' || $a->show == 'list' ) AND ($a->dropdown == "search") ) {
		
	?>
	
	<script type="text/javascript" src="jscss/jquery.searchabledropdown-1.0.7.src.js"></script>
	<script type="text/javascript">
		$(document).ready(function() {
		$("select").searchable({
		maxListSize: 1,						// if list size are less than maxListSize, show them all
